...
```{r}
geosphere::destPoint(p = cbind(individual$decimalLongitude, individual$decimalLatitude), 
                     b = individual$stemAzimuth, d = individual$stemDistance) %>%
    head()
```
...
```{r}
test <- get_stem_location(individual$decimalLongitude, individual$decimalLatitude, 
                  individual$stemAzimuth, individual$stemDistance)
test
```
...
```{r}
get_stem_location(individual$decimalLongitude, individual$decimalLatitude, 
                  individual$stemAzimuth, individual$stemDistance)
```
