...
To be able to run materials locally, you will also need to install all the required R packages.  Run the code in [`install.R`](https://github.com/annakrystalli/rrresearchACCE20/blob/master/.binder/install.R)
