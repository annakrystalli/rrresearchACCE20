...
readr::read_csv(here::here("data-raw", "wood-survey-data-master", "vst_perplotperyear.csv"))
```
...
```{r, echo=FALSE, message=FALSE}
readr::read_csv(here::here("data-raw", "wood-survey-data-master", "vst_mappingandtagging.csv"))
```
