...
knitr::include_url("assets/repo.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/fork-1.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/fork-2.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/fork-3.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/newproj-1.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/newproj-2.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/newproj-3.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/newproj-4.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/newproj-5.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/edir-1.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/edit-2.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/edit-3.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/commit-1.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/commit-2.png")
```

your new file has now been commited  

```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/commit-3.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/push-1.png")
```

changes have now been updated in the **GitHub repo**

```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/push-2.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/merge-1.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/merge-2.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/merge-3.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_url("assets/merged.png")
```
